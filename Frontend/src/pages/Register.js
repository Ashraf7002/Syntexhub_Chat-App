...
function Register({ setIsLogin }) {
  ...
  const handleRegister = async () => {
    ...
    try {
      ...
      toast.success("Welcome to ZynChat! Account created.");
      setIsLogin(true);
    } catch (err) {
        ...
        >
          ...
          >
            <div className="relative group">
              <User className="absolute left-4 top-1/2 -translate-y-1/2 h-5 w-5 text-slate-400 group-focus-within:text-whatsapp-green transition-colors" />
              <Input
